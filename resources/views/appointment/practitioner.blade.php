...
@section('content')
    ...
    <div class="container">
        ...
        @if (count($upcomingAppointments))
            <div class="row mb-4">
                ...
                @foreach ($upcomingAppointments as $day => $appointments)
                    <div class="mt-3">
                            ...
                            <div class="col-sm-12 col-md-12 mb-2">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-2 fs-1">{{ $dateHelper->getCarbonDate($appointment->meet_at)->format("H") }}
                                                h
                                            </div>
                                            <div class="col">
                                            ...
                                            <div class="col text-end">
                                                <form action="">
                                                    <button class="btn btn-warning btn-cancel-appointment" type="button"
                                                            data-bs-toggle="offcanvas" data-id="{{ $appointment->id }}"
                                                            data-bs-target="#offcanvasBottom"
                                                            aria-controls="offcanvasBottom">Annuler le rendez-vous
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
    ...
    <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel">
        <div class="offcanvas-body text-center">
            <form action="" method="POST" id="formDeleteAppointment">
                ...
                <button type="button" class="btn btn-secondary" data-bs-dismiss="offcanvas" aria-label="Close">Annuler
                </button>
    ...
    <script>
        // boucle pour sélectionner tous les boutons d'annulation d'un rendez-vous
