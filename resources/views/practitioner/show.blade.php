            ...
            <div class="row justify-content-end mb-1">
                ...
                <div class="col text-end">
                    @if ($date_previous_week)
                        <a href="{{ route('detail-practitioner', ["id" => $practitioner->id, "start_date" => $date_previous_week->format("Y-m-d")]) }}" class="btn btn-primary">Semaine précédente</a>
                    @endif


                    <a href="{{ route('detail-practitioner', ["id" => $practitioner->id, "start_date" => $date_next_week->format("Y-m-d")]) }}" class="btn btn-primary">Semaine suivante</a>
                </div>
            </div>
